  ...
  return (
    <div className="chat-container">
      ...
      <div className="conversation-list">
        ...
        <button className="new-convo" onClick={() => setIsNewConversation(true)}>+ New Conversation</button>
      </div>
        ...
        {isNewConversation ? (
          <div className="friend-connect-ui">
            ...
            <div className="connect-header">
              <button className="back-icon" onClick={() => setIsNewConversation(false)}>←</button>
            </div>
